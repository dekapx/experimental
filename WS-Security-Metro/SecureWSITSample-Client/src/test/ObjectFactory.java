...
public class ObjectFactory {
    ...
    private final static QName _SayBye_QNAME = new QName("http://test/", "sayBye");
    private final static QName _SayByeResponse_QNAME = new QName("http://test/", "sayByeResponse");
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://test/", name = "sayBye")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://test/", name = "sayByeResponse")
